  ...
  return (
    <div className='h-screen grid grid-cols-1 md:grid-cols-2'>
      <div className='relative flex flex-col items-center row-span-1 gap-8 p-4 md:row-span-6 md:justify-center md:p-0'>
        ...
        <div className='z-10 hidden text-gray-600 md:block'>
          Copyright © 2024 AIBI Tech. All rights reserved.
        </div>
      </div>
      <form
        onSubmit={handleSubmit(onSubmit)}
        className='flex flex-col justify-center mx-auto row-span-5 gap-8 p-4 md:row-span-6 w-[90%] md:w-[60%]'
      >
