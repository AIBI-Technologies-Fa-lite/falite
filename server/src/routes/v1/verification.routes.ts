...
verificationRouter.put("/case/rework/:id", roleMiddleware([Role.SUPERVISOR]), reworkCase);
verificationRouter.put("/case/complete/:id", roleMiddleware([Role.SUPERVISOR]), markCompleted);
